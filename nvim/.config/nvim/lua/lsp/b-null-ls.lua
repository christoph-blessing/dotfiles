...
M.setup = function()
	...
	local sources = {
		...
		null_ls.builtins.diagnostics.ruff.with({ condition = create_condition("ruff") }),
		null_ls.builtins.formatting.ruff.with({ condition = create_condition("ruff") }),
	}
